...
text(-1.95,1.75,'UK','HorizontalAlignment','center')
h=patchm(coastlat+0.5,coastlon+0.5,'w','FaceColor',[0.75 0.75 0.75]);
colorbar('Position',[0.165 0.075 0.3 0.02],'orientation','horizontal');

print('-dpng',[ppath 'Map_chl_zmeso_pdiff_Hist_SSP585_50s_ms.png'])
...
%text(0.2,1.65,'CAN','HorizontalAlignment','center','FontWeight','bold')
h=patchm(coastlat+0.5,coastlon+0.5,'w','FaceColor',[0.75 0.75 0.75]);
colorbar('Position',[0.165 0.45 0.3 0.025],'orientation','horizontal');
print('-dpng',[ppath 'Map_chl_zmeso_pdiff_Hist_SSP585_50s_CANonly.png'])
