...
% 1st take sqrt
Acomb = sqrt(comb(:,3:9));
Dcomb = sqrt(dcomb(:,3:9));
Jcomb = sqrt(jcomb(:,3:9));
Mcomb = sqrt(mcomb(:,3:9));
Scomb = sqrt(scomb(:,3:9));
...
save('skill_scores_hist_model_obsglm_clim_neg11_sqrt.mat','skill','simtext','metrics','ctext')
...
% set(gca,'XTickLabel',simtex)
% %ylim([-15 5])
% print('-dpng',[figp 'corr_rmse_bias_clims_200_obsglm_neg11_sqrt_subplot.png'])
...
% title('Bias')
% set(gca,'XTickLabel',ctext)
% print('-dpng',[figp 'corr_rmse_bias_clims_200_obsglm_neg11_sqrt_together.png'])
...
writetable(Tcorr,[sfile 'corr_hist_clims_200_obsglm_neg11_sqrt.csv'],'WriteRowNames',true);
writetable(Trmse,[sfile 'rmse_hist_clims_200_obsglm_neg11_sqrt.csv'],'WriteRowNames',true);
writetable(Tnstd,[sfile 'nstd_hist_clims_200_obsglm_neg11_sqrt.csv'],'WriteRowNames',true);
writetable(Turmse,[sfile 'urmse_hist_clims_200_obsglm_neg11_sqrt.csv'],'WriteRowNames',true);
writetable(Ttrmse,[sfile 'trmse_hist_clims_200_obsglm_neg11_sqrt.csv'],'WriteRowNames',true);
writetable(Tbias,[sfile 'bias_hist_clims_200_obsglm_neg11_sqrt.csv'],'WriteRowNames',true);
