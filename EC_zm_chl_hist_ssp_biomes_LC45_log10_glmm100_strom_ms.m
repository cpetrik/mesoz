...
HS = array2table(Hist.slop,'RowNames',simtext,'VariableNames',...
    {'LC','HCSS','HCPS','Global'});
SS = array2table(SSP.slop,'RowNames',smod,'VariableNames',...
    {'LC','HCSS','HCPS','Global'});

writetable(HS,[sfile 'hist_lm_slopes_obsglm100_strom_global_biomes.csv'],'WriteRowNames',true);
writetable(SS,[sfile 'ssp585_lm_slopes_obsglm100_strom_global_biomes.csv'],'WriteRowNames',true);
...
lg.AutoUpdate = 'off';
text(-2,5,'A','FontWeight','Bold','FontSize',14)
...
xlim([round(cmin) round(cmax)])
title('SSP 585')
text(-2,5,'B','FontWeight','Bold','FontSize',14)

subplot(4,4,3)
plot(x,x,':k'); hold on;
plot(Oy4,xs,'k','LineWidth',1.5); hold on;
plot(Sy4,xs,'color',[0.4 0.4 0.4],'LineWidth',1.5); hold on;
...
text(0.2,2.45,'C','FontWeight','Bold','FontSize',14)
...
plot(Sy1,xs,'color',[0.4 0.4 0.4],'LineWidth',1.5); hold on;
...
plot(Sy2,xs,'color',[0.4 0.4 0.4],'LineWidth',1.5); hold on;
...
plot(Sy3,xs,'color',[0.4 0.4 0.4],'LineWidth',1.5); hold on;
...
print('-dpng',[figp 'Hist_SSP585_lm_EC_zmeso_chl_global_biomes_LC45_glmm100_stromberg_ms.png'])
...
title('Hist')
ylabel({'Global','log_1_0 zmeso'})
text(-2,3,'A','FontWeight','Bold','FontSize',14)
...
xlim([round(cmin) round(cmax)])
title('SSP 585')
text(-2,3,'B','FontWeight','Bold','FontSize',14)
...
title('Future chl sensitivity')
text(0.2,1.85,'C','FontWeight','Bold','FontSize',14)
...
xlabel('Historic chl sensitivity')
print('-dpng',[figp 'Hist_SSP585_lm_EC_zmeso_chl_global_biomes_LC45_glmm100_stromberg_ms_noCAN.png'])
