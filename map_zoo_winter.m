...
% title('Winter 1/2^o')
% print('-dpng','Total_zoo_carbon_mass_winter_half.png')
...
h=patchm(lat+0.5,long+0.5,'w','FaceColor',[0.75 0.75 0.75]);
title('Winter 1^o')
print('-dpng','Total_zoo_carbon_mass_winter_one.png')

%% save
fileid = COPEPOD2012fileidentifier(1);
units = 'Total Carbon Mass mgC m-3';
save('copepod-2012_cmass_DJF_gridded.mat','lat_c','lon_c','zoo_c','lat_g','lon_g',...
    'zoo_g','fileid','units');
