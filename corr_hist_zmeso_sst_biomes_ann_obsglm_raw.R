...
png(paste0(figp,'corr_hist_mesoz_sst_biomes_all_log_obsglm.png'), 
...
write.table(Bcorr,"Hist_corrs_mod_sst_biomes_obsglm.csv",sep=",",row.names=T)
...
Clm2 <- lm(Lzmeso~sst, data=subset(CM, biome==2))
Clm3 <- lm(Lzmeso~sst, data=subset(CM, biome==3))
summary(Clm1)
summary(Clm2)
summary(Clm3)
...
Nlm2 <- lm(Lzmeso~sst, data=subset(NM, biome==2))
Nlm3 <- lm(Lzmeso~sst, data=subset(NM, biome==3))
summary(Nlm1)
summary(Nlm2)
summary(Nlm3)
...
Glm2 <- lm(Lzmeso~sst, data=subset(GM, biome==2))
Glm3 <- lm(Lzmeso~sst, data=subset(GM, biome==3))
summary(Glm1)
summary(Glm2)
summary(Glm3)
...
Ilm2 <- lm(Lzmeso~sst, data=subset(IM, biome==2))
Ilm3 <- lm(Lzmeso~sst, data=subset(IM, biome==3))
summary(Ilm1)
summary(Ilm2)
summary(Ilm3)
...
Ulm2 <- lm(Lzmeso~sst, data=subset(UM, biome==2))
Ulm3 <- lm(Lzmeso~sst, data=subset(UM, biome==3))
summary(Ulm1)
summary(Ulm2)
summary(Ulm3)
...
Olm2 <- lm(Lzmeso~sst, data=subset(OG, biome==2))
Olm3 <- lm(Lzmeso~sst, data=subset(OG, biome==3))
summary(Olm1)
summary(Olm2)
summary(Olm3)
...
write.table(Cff1,"Hist_coeffs_mod_sst_biome1_LC_obsglm.csv",sep=",",row.names=T)
...
names(Cff2) <- c("Intercept","sst")
row.names(Cff2) <- c("CAN","CNRM","GFDL","IPSL","UKESM","obs")
write.table(Cff2,"Hist_coeffs_mod_sst_biome2_HCSS_obsglm.csv",sep=",",row.names=T)
...
names(Cff3) <- c("Intercept","sst")
row.names(Cff3) <- c("CAN","CNRM","GFDL","IPSL","UKESM","obs")
write.table(Cff3,"Hist_coeffs_mod_sst_biome3_HCPS_obsglm.csv",sep=",",row.names=T)
