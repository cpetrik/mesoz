...
hpath = '/Volumes/MIP/Fish-MIP/CMIP6/CNRM-ESM2-1/ssp585/';


%% Hist
load([hpath 'cnrm_ssp585_zmeso_200_climatol_2051_2100.mat']);
...
%% input grid not regular (triploar?)
LAT = lat;
LON = lon;
...
title('All 1^o')
print('-dpng','cnrm_ssp585_zoo_carbon_mass_all.png')

%% save
units = 'Total Carbon Mass mgC m-2';
save([hpath 'cnrm_ssp585_zmeso_200_climatol_2051_2100_gridded.mat'],...
    'lat_g','lon_g',...
