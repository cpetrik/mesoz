...
%% Hist
load([hpath 'gfdl_ssp585_zmeso_200_climatol_2051_2100.mat']);
...
title('All 1^o')
print('-dpng','gfdl_ssp585_zoo_carbon_mass_all.png')

%% save
units = 'Total Carbon Mass mgC m-2';
save([hpath 'gfdl_ssp585_zmeso_200_climatol_2051_2100_gridded.mat'],...
    'lat_g','lon_g',...
