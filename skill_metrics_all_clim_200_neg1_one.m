...
save('skill_scores_hist_model_obsglm_clim_neg11.mat','skill','simtext','metrics','ctext')
...
writetable(Tcorr,'corr_hist_clims_200_obsglm_neg11.csv','WriteRowNames',true);
writetable(Trmse,'rmse_hist_clims_200_obsglm_neg11.csv','WriteRowNames',true);
writetable(Tnstd,'nstd_hist_clims_200_obsglm_neg11.csv','WriteRowNames',true);
writetable(Turmse,'urmse_hist_clims_200_obsglm_neg11.csv','WriteRowNames',true);
writetable(Ttrmse,'trmse_hist_clims_200_obsglm_neg11.csv','WriteRowNames',true);
writetable(Tbias,'bias_hist_clims_200_obsglm_neg11.csv','WriteRowNames',true);
