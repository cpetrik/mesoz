...
load([fpath 'UKESM_ssp585_biomes.mat'],'biomes');

%% UKESM zmeso
npath = '/Volumes/MIP/Fish-MIP/CMIP6/UKESM1-0-LL/ssp585/';
load([npath 'ukesm_ssp585_zmeso200_onedeg_climatol_2051_2100.mat']);
...
%% UKESM chl and sst
load([npath 'ukesm_ssp585_chl_sst_onedeg_climatol_2051_2100.mat'],...
...
save('ukesm_ssp585_zmeso200_chl_sst_clim_2051_2100_biomes.mat','model','comb','obsmod');
writetable(obsmod,'ukesm_ssp585_zmeso200_chl_sst_clim_2051_2100_biomes.csv')
