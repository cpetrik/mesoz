...
load('skill_scores_hist_model_obsglm100_clim_raw_4rt.mat')
...
axis([0 180 0 4])
title('Fourth root')
text(2.2,7,'A','FontWeight','Bold','FontSize',14)
...
load('skill_scores_hist_model_obsglm100_clim_neg11_4rt.mat')
...
set(gca,'ThetaTick',(90/1.5708)*thetaTickN,'ThetaTickLabel',...
    {'0.9','0.6','0.3','0','-0.3','-0.6','-0.9'})
axis([0 180 0 1.5])
title('Fourth root scaled -1 to 1')
text(2.2,2.6,'B','FontWeight','Bold','FontSize',14)
...
%%
print('-dpng',[figp 'Taylor_all_clim_together_obsglm100_raw_neg11_4rt_v3.png'])
