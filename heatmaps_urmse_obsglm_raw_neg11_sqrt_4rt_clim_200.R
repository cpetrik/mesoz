...
rval <- read.csv(paste0(ddir,"corr_hist_clims_200_obsglm_raw_sqrt.csv"),sep=",",header = T,stringsAsFactors = F)
rms <- read.csv(paste0(ddir,"urmse_hist_clims_200_obsglm_raw_sqrt.csv"),sep=",",header = T,stringsAsFactors = F)
bia <- read.csv(paste0(ddir,"bias_hist_clims_200_obsglm_raw_sqrt.csv"),sep=",",header = T,stringsAsFactors = F)
...
grb <- ggplot(data = bia3, aes(y=Model, x=Season, fill=Bias)) + 
  geom_tile(color = "white")+
  scale_fill_distiller(palette = "PRGn", name="Bias", limit = c(-1.1,1.1)) +
  theme_minimal()+ 
  theme(axis.text.x = element_text(angle = 45, vjust = 1, 
                                   size = 8, hjust = 1))+
  coord_fixed() + 
...
### -------------------------------- Raw 4rt -------------------------------
# load data
frval <- read.csv(paste0(ddir,"corr_hist_clims_200_obsglm_raw_4rt.csv"),sep=",",header = T,stringsAsFactors = F)
frms <- read.csv(paste0(ddir,"urmse_hist_clims_200_obsglm_raw_4rt.csv"),sep=",",header = T,stringsAsFactors = F)
fbia <- read.csv(paste0(ddir,"bias_hist_clims_200_obsglm_raw_4rt.csv"),sep=",",header = T,stringsAsFactors = F)
...
frb <- ggplot(data = fbia3, aes(y=Model, x=Season, fill=Bias)) + 
  geom_tile(color = "white")+
  scale_fill_distiller(palette = "PRGn", name="Bias", limit = c(-0.8,0.8)) +
  theme_minimal()+ 
  theme(axis.text.x = element_text(angle = 45, vjust = 1, 
                                   size = 8, hjust = 1))+
  coord_fixed() + 
...
### -------------------------------- -1 to 1 using sqrt -------------------------------
# load data
nrval <- read.csv(paste0(ddir,"corr_hist_clims_200_obsglm_neg11_sqrt.csv"),sep=",",header = T,stringsAsFactors = F)
nrms <- read.csv(paste0(ddir,"urmse_hist_clims_200_obsglm_neg11_sqrt.csv"),sep=",",header = T,stringsAsFactors = F)
nbia <- read.csv(paste0(ddir,"bias_hist_clims_200_obsglm_neg11_sqrt.csv"),sep=",",header = T,stringsAsFactors = F)
...
### -------------------------------- -1 to 1 using 4th rt -------------------------------
# load data
zrval <- read.csv(paste0(ddir,"corr_hist_clims_200_obsglm_neg11_4rt.csv"),sep=",",header = T,stringsAsFactors = F)
zrms <- read.csv(paste0(ddir,"urmse_hist_clims_200_obsglm_neg11_4rt.csv"),sep=",",header = T,stringsAsFactors = F)
zbia <- read.csv(paste0(ddir,"bias_hist_clims_200_obsglm_neg11_4rt.csv"),sep=",",header = T,stringsAsFactors = F)
...
png(paste0(figp,'Heatmaps_urmse_clims_200_obsglm_raw_neg11_sqrt_4rt_v2.png'), 
    width = 15*300,        # 5 x 300 pixels
    height = 9*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)
plot_grid( gr,fr,sr,zr,grm,frm,srm,zrm,grb,frb,srb,zrb,
           nrow = 3, ncol = 4,
