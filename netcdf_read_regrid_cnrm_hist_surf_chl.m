...
%%
ncdisp([fpath 'chlos_Omon_CNRM-ESM2-1_historical_r1i1p1f2_gn_185001-201412_onedeg.nc'])
...
%% All years
ncid = netcdf.open([fpath 'chlos_Omon_CNRM-ESM2-1_historical_r1i1p1f2_gn_185001-201412_onedeg.nc'],'NC_NOWRITE');
...
%%
save([fpath 'cnrm_hist_surf_chl_monthly_onedeg_1951_2014.mat'],'schl',...
