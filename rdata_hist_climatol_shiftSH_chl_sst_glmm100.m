...
save('cmip6_hist_space_means_50yr_chl_sst_glmm100_same_orientation.mat',...
    'cchl_all','mchl_all','nchl_all','gchl_all','ichl_all','uchl_all','ochl_all',...
    'csst_all','msst_all','nsst_all','gsst_all','isst_all','usst_all','osst_all',...
    'lon_g','lat_g');
...
writetable(tchl,'hist_chl_model_obsglm100_all_clim.csv')

tsst = array2table(matt,'VariableNames',...
    {'Lat','Lon','CAN','CMCC','CNRM','GFDL','IPSL','UK','obsGLM'});
writetable(tsst,'hist_sst_model_obsglm100_all_clim.csv')

%%
save('hist_chl_sst_model_obsglm100_climatols.mat','matc','matt')
