...
load([fpath 'GFDL_historical_biomes.mat'],'biomes');

%% GFDL zmeso
npath = '/Volumes/MIP/Fish-MIP/CMIP6/GFDL/hist/';
load([npath 'gfdl_hist_zmeso200_onedeg_climatol_1965_2014.mat']);
% Climatol of last 50 yrs
zmo_all(zmo_all(:)<0) = 0;
zunits = units_vint;

%% GFDL chl and sst
load([npath 'gfdl_hist_chl_sst_onedeg_climatol_1965_2014.mat'],...
...
save('gfdl_hist_zmeso200_chl_sst_clim_1965_2014_biomes.mat','model','comb','obsmod');
writetable(obsmod,'gfdl_hist_zmeso200_chl_sst_clim_1965_2014_biomes.csv')
