...
%% Meso Zoop zall
ncdisp([fpath 'zmeso_Omon_CNRM-ESM2-1_ssp126_r1i1p1f2_gn_201501-206412.nc'])
...
%% Early years
ncid = netcdf.open([fpath 'zmeso_Omon_CNRM-ESM2-1_ssp126_r1i1p1f2_gn_201501-206412.nc'],'NC_NOWRITE');
...
%% Subset of thkcello
tcid = netcdf.open([fpath 'thkcello_Omon_CNRM-ESM2-1_ssp126_r1i1p1f2_gn_201501-206412.nc'],'NC_NOWRITE');
...
%% Later
ncid = netcdf.open([fpath 'zmeso_Omon_CNRM-ESM2-1_ssp126_r1i1p1f2_gn_206501-210012.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
% Get all other vars 1st
for n = 1:(nvars-1)
    varname = netcdf.inqVar(ncid, n-1);
...
tcid = netcdf.open([fpath 'thkcello_Omon_CNRM-ESM2-1_ssp126_r1i1p1f2_gn_206501-210012.nc'],'NC_NOWRITE');
...
save([fpath 'cnrm_ssp126_zmeso_200_monthly_2015_2100.mat'],'zmeso_200','yr1',...
