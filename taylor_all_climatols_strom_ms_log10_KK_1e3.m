...
mtex = {'obsSM','CAN','CMCC','CNRM','GFDL','IPSL','UK'};
...
axis([0 180 0 4])
text(-0.2,2.5,'Standard deviation','HorizontalAlignment','center')
...
print('-dpng',[figp 'Taylor_all_clim_together_stromberg_log10_ms_KK_1e4.png'])
