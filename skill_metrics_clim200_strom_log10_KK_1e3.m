...
%% Standardization
% log10
Acomb = log10(comb(:,3:9)+1e-3);
Dcomb = log10(dcomb(:,3:9)+1e-3);
Jcomb = log10(jcomb(:,3:9)+1e-3);
Mcomb = log10(mcomb(:,3:9)+1e-3);
Scomb = log10(scomb(:,3:9)+1e-3);
...
simtext = {'obsSM','CAN','CMCC','CNRM','GFDL','IPSL','UK'};
simtex = {'CA','CM','CN','GF','IP','UK'};
ctext = {'All','Winter','Spring','Summer','Fall'};

save([sfile 'skill_scores_hist_model_stromberg_clim_log10_KK_1e4.mat'],'skill',...
...
writetable(Tcorr,[sfile 'corr_hist_clims_200_stromberg_log10_KK_1e4.csv'],'WriteRowNames',true);
writetable(Trmse,[sfile 'rmse_hist_clims_200_stromberg_log10_KK_1e4.csv'],'WriteRowNames',true);
writetable(Tnstd,[sfile 'nstd_hist_clims_200_stromberg_log10_KK_1e4.csv'],'WriteRowNames',true);
writetable(Turmse,[sfile 'urmse_hist_clims_200_stromberg_log10_KK_1e4.csv'],'WriteRowNames',true);
writetable(Tmae,[sfile 'mae_hist_clims_200_stromberg_log10_KK_1e4.csv'],'WriteRowNames',true);
writetable(Tbias,[sfile 'bias_hist_clims_200_stromberg_log10_KK_1e4.csv'],'WriteRowNames',true);
...
writetable(TAcomb,[sfile 'climatol_All_hist_clims_200_stromberg_log10_1e4.csv'],'WriteRowNames',false);
writetable(TDcomb,[sfile 'climatol_DJF_hist_clims_200_stromberg_log10_1e4.csv'],'WriteRowNames',false);
writetable(TJcomb,[sfile 'climatol_JJA_hist_clims_200_stromberg_log10_1e4.csv'],'WriteRowNames',false);
writetable(TMcomb,[sfile 'climatol_MAM_hist_clims_200_stromberg_log10_1e4.csv'],'WriteRowNames',false);
writetable(TScomb,[sfile 'climatol_SON_hist_clims_200_stromberg_log10_1e4.csv'],'WriteRowNames',false);
