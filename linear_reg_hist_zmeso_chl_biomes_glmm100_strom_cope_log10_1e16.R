...
#everything (except obsMO) from gC to mgC
CM$zmeso <- (CM$mesoz*1e3)
MM$zmeso <- (MM$mesoz*1e3)
NM$zmeso <- (NM$mesoz*1e3)
GM$zmeso <- (GM$mesoz*1e3)
IM$zmeso <- (IM$mesoz*1e3)
UM$zmeso <- (UM$mesoz*1e3)
OG$zmeso <- (OG$mesoz*1e3)
OS$zmeso <- (OS$mesoz*1e3)
