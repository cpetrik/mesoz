...
load('glm_output_by_biom_v2w.mat')
...
lg = legend(nexttile(3),{'CAN','CMCC','CNRM','GFDL','IPSL','UKESM','obsGLMM'});
lg.Location = 'eastoutside';
print('-dpng',[ppath 'Hist_ts_biome_areaw_means_zmeso200_schl_sst_cb_legend.png'])
...
print('-dpng',[ppath 'Hist_ts_biome_areaw_means_zmeso200_schl_sst_cb_leg_noOBS.png'])
