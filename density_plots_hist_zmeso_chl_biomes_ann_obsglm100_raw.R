...
png(paste0(figp,'scatter_hist_mesoz_chl_biomes_all_log_obsglm100_LC45_v2.png'), 
...
png(paste0(figp,'scatter_hist_mesoz_chl_biomes_CAN_log_obsglm100_LC45.png'), 
...
## With Global
png(paste0(figp,'scatter_hist_mesoz_chl_biomes_global_all_log_obsglm100_LC45_v2.png'), 
...
png(paste0(figp,'scatter_hist_mesoz_chl_biomes_global_CAN_log_obsglm100_LC45.png'), 
    width = 8*300,        # 5 x 300 pixels
    height = 2*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)
