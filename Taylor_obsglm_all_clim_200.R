...
# other version
library(plotrix)
oldpar<-taylor.diagram(Tr2$obsGLM,Tr2$CAN,col="green4",pos.cor=FALSE)
taylor.diagram(Tr2$obsGLM,Tr2$CNRM,add=TRUE,col="blue",pos.cor=FALSE)
taylor.diagram(Tr2$obsGLM,Tr2$GFDL,add=TRUE,col="purple3",pos.cor=FALSE)
taylor.diagram(Tr2$obsGLM,Tr2$IPSL,add=TRUE,col="red3",pos.cor=FALSE)
taylor.diagram(Tr2$obsGLM,Tr2$UK,add=TRUE,col="maroon4",pos.cor=FALSE)
# get approximate legend position
lpos<-5*sd(Tr2$obsGLM)
# add a legend
legend(lpos,lpos,legend=c("CAN","CNRM","GFDL","IPSL","UK"),pch=19,
       col=c("green4","blue","purple3","red3","maroon4"))
...
pdf( file = paste0(figp,'Taylor_obsglm_all_clim_200_norm.pdf')) #, width = unit( 5, 'cm' ), height = unit( 5, 'cm' ) )
...
pdf( file = paste0(figp,'Taylor_obsglm_all_clim_200_anom.pdf')) #, width = unit( 5, 'cm' ), height = unit( 5, 'cm' ) )
...
pdf( file = paste0(figp,'Taylor_obsglm_all_clim_200_01.pdf')) #, width = unit( 5, 'cm' ), height = unit( 5, 'cm' ) )
...
pdf( file = paste0(figp,'Taylor_obsglm_all_clim_200_all.pdf'), width = unit( 8, 'cm' ), height = unit( 10, 'cm' ) )
