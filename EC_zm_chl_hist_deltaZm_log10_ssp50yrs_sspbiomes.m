...
%% Delta zmeso
load('delta_log10_means_areaw_hist_ssp585_50yr_zmeso200_sspbiomes.mat');
...
title('Future change')
text(0.02,0.07,'B','FontWeight','Bold','FontSize',14)
...
print('-dpng',[figp 'Hist_lm_SSP585_delta_log10_EC_global_sspbiomes.png'])
...
axis([-0.5 1 -0.08 0.02])
xlabel('Historic relationship')
ylabel('\Delta (log_1_0 zmeso)')
print('-dpng',[figp 'Hist_lm_SSP585_delta_log10_EC_global_sspbiomes_noCAN.png'])
