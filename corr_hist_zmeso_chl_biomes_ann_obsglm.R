...
write.table(Cff1,"Hist_coeffs_mod_chl_biome1_LC_obsglm.csv",sep=",",row.names=T)
...
write.table(Oerr1,"Hist_stderr_predict_obsglm_chl_biome1.csv",sep=",",row.names=T)
write.table(Oerr2,"Hist_stderr_predict_obsglm_chl_biome2.csv",sep=",",row.names=T)
write.table(Oerr3,"Hist_stderr_predict_obsglm_chl_biome3.csv",sep=",",row.names=T)
...
write.table(Er,"Hist_stderr_coeff_obsglm_chl_all_biomes.csv",sep=",",row.names=T)
