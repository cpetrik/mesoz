...
load([fpath 'IPSL_ssp585_biomes.mat'],'biomes');

%% IPSL zmeso
npath = '/Volumes/MIP/Fish-MIP/CMIP6/IPSL/ssp585/';
load([npath 'ipsl_ssp585_zmeso200_onedeg_climatol_2051_2100.mat']);
...
%% IPSL chl and sst
load([npath 'ipsl_ssp585_chl_sst_onedeg_climatol_2051_2100.mat'],...
...
save('ipsl_ssp585_zmeso200_chl_sst_clim_2051_2100_biomes.mat','model','comb','obsmod');
writetable(obsmod,'ipsl_ssp585_zmeso200_chl_sst_clim_2051_2100_biomes.csv')
