...
load('skill_scores_hist_model_obsglm_clim_raw.mat')
...
for i = 1:length(r)
    ...
    text(th1(20),r1(20),num2str(r(i)),'color',[0.7 0.7 0.7]);
end
%add all other data
for s=2:6
    hA=polarplot(thetaA(s),rhoA(s),'o'); hold on;
...
%% Norm -----------------------------------------------
load('skill_scores_hist_model_obsglm_clim_norm.mat')
...
%%
print('-dpng',[figp 'Taylor_all_clim_together_obsglm_raw_norm.png'])
