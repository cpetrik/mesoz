...
Tmeanz = array2table(zmeans_diff,'RowNames',simtext,'VariableNames',...
    {'Global','LC','HCSS','HCPS'});
writetable(Tmeanz,[sfile 'delta_log10_means_areaw_hist_ssp585_50yr_zmeso200_sspbiomes.csv'],'WriteRowNames',true);
save('delta_log10_means_areaw_hist_ssp585_50yr_zmeso200_sspbiomes.mat',...
    'Tmeanz','zmeans_diff');
