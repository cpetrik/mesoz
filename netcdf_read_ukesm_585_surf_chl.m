...
%% chl zall
ncdisp([fpath 'ukesm1-0-ll_r1i1p1f2_ssp585_chl_onedeg_global_monthly_2015_2100.nc'])
...
%%
ncid = netcdf.open([fpath 'ukesm1-0-ll_r1i1p1f2_ssp585_chl_onedeg_global_monthly_2015_2100.nc'],'NC_NOWRITE');
...
%%
save([fpath 'ukesm_isimip_ssp585_surf_chl_monthly_2015_2100.mat'],'schl',...
