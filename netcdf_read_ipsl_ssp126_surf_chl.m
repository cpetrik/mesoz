...
%% chl zall
ncdisp([fpath 'ipsl-cm6a-lr_r1i1p1f1_ssp126_chl_onedeg_global_monthly_2015_2100.nc'])
...
%%
ncid = netcdf.open([fpath 'ipsl-cm6a-lr_r1i1p1f1_ssp126_chl_onedeg_global_monthly_2015_2100.nc'],'NC_NOWRITE');
...
%%
save([fpath 'ipsl_ssp126_surf_chl_monthly_2015_2100.mat'],'schl','yr',...
