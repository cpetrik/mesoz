...
set(gca,'XTickLabel',simtex)
%ylim([-15 5])
print('-dpng',[figp 'corr_rmse_bias_clims_200_obsglm_anom_subplot.png'])

%%
ctext = {'All','Winter','Spring','Summer','Fall'};
save('skill_scores_model_obsglm_clim_anom.mat','skill','simtext','metrics','ctext')
...
title('Bias')
set(gca,'XTickLabel',ctext)
print('-dpng',[figp 'corr_rmse_bias_clims_200_obsglm_anom_together.png'])
...
writetable(Tcorr,'corr_clims_200_obsglm_anom.csv','WriteRowNames',true);
writetable(Trmse,'rmse_clims_200_obsglm_anom.csv','WriteRowNames',true);
writetable(Tnstd,'nstd_clims_200_obsglm_anom.csv','WriteRowNames',true);
writetable(Turmse,'urmse_clims_200_obsglm_anom.csv','WriteRowNames',true);
writetable(Ttrmse,'trmse_clims_200_obsglm_anom.csv','WriteRowNames',true);
writetable(Tbias,'bias_clims_200_obsglm_anom.csv','WriteRowNames',true);
