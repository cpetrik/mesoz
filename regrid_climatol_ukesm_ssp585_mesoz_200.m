...
hpath = '/Volumes/MIP/Fish-MIP/CMIP6/UKESM1-0-LL/ssp585/';

%% Hist
load([hpath 'ukesm_isimip_ssp585_zmeso_200_climatol_2051_2100.mat']);
...
%% 
zD = interp2(LAT,LON,uzD,lat_g,lon_g);
zM = interp2(LAT,LON,uzM,lat_g,lon_g);
zJ = interp2(LAT,LON,uzJ,lat_g,lon_g);
zS = interp2(LAT,LON,uzS,lat_g,lon_g);
zall = interp2(LAT,LON,uzA,lat_g,lon_g);
...
title('All 1^o')
print('-dpng','ukesm_ssp585_zoo_carbon_mass_all.png')

%% save
units = 'Total Carbon Mass mgC m-2';
save([hpath 'ukesm_ssp585_zmeso_200_climatol_2051_2100_gridded.mat'],...
    'lat_g','lon_g',...
