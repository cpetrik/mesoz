...
ylabel('HCPS')
xlim([1 12])
print('-dpng',[ppath 'Hist_ts_biome_means_zmeso200_schl_sst_cb.png'])
...
lg = legend(nexttile(3),{'CAN','CNRM','GFDL','IPSL','UKESM','obsGLMM'});
lg.Location = 'eastoutside';
print('-dpng',[ppath 'Hist_ts_biome_means_zmeso200_schl_sst_cb_v2.png'])
...
% fig = gcf;
% fig.Position(3) = fig.Position(3) + 150;
lg  = legend({'CAN','CNRM','GFDL','IPSL','UKESM','obsGLMM'}); 
lg.Position(1:2) = [.725 .425];
print('-dpng',[ppath 'Hist_ts_biome_means_zmeso200_schl_sst_cb_v3.png'])
