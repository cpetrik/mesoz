...
png(paste0(figp,'corr_ssp585_mesoz_chl_biomes_all_log_obsglm_LC45.png'), 
...
png(paste0(figp,'corr_ssp585_mesoz_chl_biomes_CAN_log_obsglm_LC45.png'), 
...
row.names(Bcorr) <- c("biome","CAN","CMCC","CNRM","GFDL","IPSL","UKESM")
...
row.names(Cff0) <- c("CAN","CMCC","CNRM","GFDL","IPSL","UKESM")
write.table(Cff0,"SSP585_coeffs_mod_chl_global_obsglm.csv",sep=",",row.names=T)
...
row.names(Cff1) <- c("CAN","CMCC","CNRM","GFDL","IPSL","UKESM")
...
row.names(Cff2) <- c("CAN","CMCC","CNRM","GFDL","IPSL","UKESM")
...
row.names(Cff3) <- c("CAN","CMCC","CNRM","GFDL","IPSL","UKESM")
