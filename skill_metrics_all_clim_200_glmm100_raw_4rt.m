...
save('skill_scores_hist_model_obsglm100_clim_raw_4rt.mat','skill','simtext','metrics','ctext')
...
% title('Bias')
% set(gca,'XTickLabel',ctext)
% print('-dpng',[figp 'corr_rmse_bias_clims_200_obsglm_raw_4rt_together.png'])
...
writetable(Tcorr,[sfile 'corr_hist_clims_200_obsglm100_raw_4rt.csv'],'WriteRowNames',true);
writetable(Trmse,[sfile 'rmse_hist_clims_200_obsglm100_raw_4rt.csv'],'WriteRowNames',true);
writetable(Tnstd,[sfile 'nstd_hist_clims_200_obsglm100_raw_4rt.csv'],'WriteRowNames',true);
writetable(Turmse,[sfile 'urmse_hist_clims_200_obsglm100_raw_4rt.csv'],'WriteRowNames',true);
writetable(Ttrmse,[sfile 'trmse_hist_clims_200_obsglm100_raw_4rt.csv'],'WriteRowNames',true);
writetable(Tbias,[sfile 'bias_hist_clims_200_obsglm100_raw_4rt.csv'],'WriteRowNames',true);
