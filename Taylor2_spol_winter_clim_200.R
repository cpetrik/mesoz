...
# load data
Tr <- read.csv("obs_mod_chl_spol_winter_clim_200.csv",sep=",",header = T,stringsAsFactors = F)
...
pdf( file = 'Taylor_spol_clim_200_log.pdf') #, width = unit( 5, 'cm' ), height = unit( 5, 'cm' ) )
...
pdf( file = 'Taylor_noCAN_spol_clim_200_log.pdf') #, width = unit( 5, 'cm' ), height = unit( 5, 'cm' ) )
