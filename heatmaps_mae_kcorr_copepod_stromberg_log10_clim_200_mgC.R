...
frval <- read.csv(paste0(ddir,"corr_hist_clims_200_copepod_log10_KK_1e4_mgC.csv"),sep=",",header = T,stringsAsFactors = F)
kval <- read.csv(paste0(ddir,"Kendall_corr_hist_clims_200_copepod_log10_KK_1e4_mgC.csv"),sep=",",header = T,stringsAsFactors = F)
sval <- read.csv(paste0(ddir,"Spearman_corr_hist_clims_200_copepod_log10_KK_1e4_mgC.csv"),sep=",",header = T,stringsAsFactors = F)
frms <- read.csv(paste0(ddir,"urmse_hist_clims_200_copepod_log10_KK_1e4_mgC.csv"),sep=",",header = T,stringsAsFactors = F)
fbia <- read.csv(paste0(ddir,"bias_hist_clims_200_copepod_log10_KK_1e4_mgC.csv"),sep=",",header = T,stringsAsFactors = F)
fmae <- read.csv(paste0(ddir,"mae_hist_clims_200_copepod_log10_KK_1e4_mgC.csv"),sep=",",header = T,stringsAsFactors = F)
