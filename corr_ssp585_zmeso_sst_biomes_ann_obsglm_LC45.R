...
png(paste0(figp,'corr_ssp585_mesoz_sst_biomes_all_log_LC45.png'), 
...
write.table(Bcorr,"SSP585_corrs_mod_sst_biomes_LC45.csv",sep=",",row.names=T)
...
write.table(Cff1,"SSP585_coeffs_mod_sst_biome1_LC45.csv",sep=",",row.names=T)
