...
zD = griddata(LAT,LON,izD,lat_g,lon_g);
zM = griddata(LAT,LON,izM,lat_g,lon_g);
zJ = griddata(LAT,LON,izJ,lat_g,lon_g);
zS = griddata(LAT,LON,izS,lat_g,lon_g);
zall = griddata(LAT,LON,izA,lat_g,lon_g);
...
save([hpath 'ipsl_hist_zmeso_vint_climatol_1950_2014_gridded.mat'],...
    'lat_g','lon_g',...
