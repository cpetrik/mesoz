...
%% Paths
hpath = '/Volumes/MIP/Fish-MIP/CMIP6/GFDL/ssp585/';
...
%% Hist
load([hpath 'gfdl_ssp585_chl_sst_climatol_2051_2100.mat']);
...
h=patchm(lat+0.5,long+0.5,'w','FaceColor',[0.75 0.75 0.75]);
title('All 1^o')
%print('-dpng','gfdl_chl_all.png')

%% save
save([hpath 'gfdl_ssp585_chl_sst_climatol_2051_2100_gridded.mat'],...
    'lat_g','lon_g',...
