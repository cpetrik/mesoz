...
%1e3 mg in 1 g
HCzm = HCzm10 * 12.01 * 1e3;
HNzm = HNzm10 * 12.01 * 1e3;
HGzm = HGzm10 * 12.01 * 1e3;
HIzm = HIzm10 * 12.01 * 1e3;
HUzm = HUzm10 * 12.01 * 1e3;

FCzm = FCzm10 * 12.01 * 1e3;
FNzm = FNzm10 * 12.01 * 1e3;
FGzm = FGzm10 * 12.01 * 1e3;
FIzm = FIzm10 * 12.01 * 1e3;
FUzm = FUzm10 * 12.01 * 1e3;
...
HGchl = fliplr(HGchl);
FGchl = fliplr(FGchl);
HIsst10 = fliplr(HIsst10);
HGsst10 = fliplr(HGsst10);
HUsst10 = fliplr(HUsst10);
FIsst10 = fliplr(FIsst10);
FGsst10 = fliplr(FGsst10);
FUsst10 = fliplr(FUsst10);
lat_g = fliplr(lat_g);

%% Diffs 
diff_ct = FCsst10 - HCsst10;
diff_nt = FNsst10 - HNsst10;
diff_gt = FGsst10 - HGsst10;
diff_it = FIsst10 - HIsst10;
diff_ut = FUsst10 - HUsst10;
...
h=patchm(coastlat+0.5,coastlon+0.5,'w','FaceColor',[0.75 0.75 0.75]);
print('-dpng',[ppath 'Map_SST_diff_Hist_SSP585_10yr.png'])
...
print('-dpng',[ppath 'Map_chl_pdiff_Hist_SSP585_10yr.png'])
...
print('-dpng',[ppath 'Map_zmeso_pdiff_Hist_SSP585_10yr.png'])
