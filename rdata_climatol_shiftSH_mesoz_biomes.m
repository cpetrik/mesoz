...
load([cpath 'can_ssp585_zmeso200_onedeg_climatol_2015_2100.mat'],...
...
load([npath 'cnrm_ssp585_zmeso200_onedeg_climatol_2015_2100.mat'],...
    'zmo_all','zmo_DJF','zmo_JJA','zmo_MAM','zmo_SON','units');
...
load([upath 'ukesm_ssp585_zmeso200_onedeg_climatol_2015_2100.mat'],...
    'zmo_all','zmo_DJF','zmo_JJA','zmo_MAM','zmo_SON')%,'units');
...
load([ipath 'ipsl_ssp585_zmeso200_onedeg_climatol_2015_2100.mat'],...
    'zmo_all','zmo_DJF','zmo_JJA','zmo_MAM','zmo_SON');%,'units');
...
load([gpath 'gfdl_ssp585_zmeso200_onedeg_climatol_2015_2100.mat']);
...
load([fpath 'CanESM_ssp585_biomes.mat'],'hcbiomes');
load([fpath 'CNRM_ssp585_biomes.mat'],'hnbiomes');
load([fpath 'GFDL_ssp585_biomes.mat'],'hgbiomes');
load([fpath 'IPSL_ssp585_biomes.mat'],'hibiomes');
load([fpath 'UKESM_ssp585_biomes.mat'],'hubiomes','lat','lon');
load([bpath 'data_biomes_MODISAqua_x1.mat'],'biomes');
...
obsmod = array2table(comb,'VariableNames',...
    ...
    'CAbiome','CNbiome','GFbiome','IPbiome','UKbiome','obsbiome'});
writetable(obsmod,'skill_ssp585_model_obsglm_all_clim_200.csv')
...
%%
save('skill_model_obsglm_climatols.mat','comb','dcomb','jcomb','mcomb','scomb')
