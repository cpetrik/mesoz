...
%% 
load('obs_mod_chl_trop_all_clim_200.mat')
obs = obsmodchl(:,3);
model = obsmodchl(:,4:8);
...
subplot(3,2,2)
bar(skill(1,:),'k')
text(-1,0.65,'Annual Correlation coefficient','FontWeight','Bold','HorizontalAlignment','center')
set(gca,'XTickLabel',simtex)
ylim([0 0.55])

subplot(3,2,4)
bar(skill(2,:),'k')
text(-1,0.8,'Root mean square error','FontWeight','Bold','HorizontalAlignment','center')
set(gca,'XTickLabel',simtex)
ylim([0 0.7])
...
ylim([-0.8 0.4])
stamp('Trop Annual')
print('-dpng','corr_rmse_mef_trop_all_clim_200.png')
...
print('-dpng','Taylor_trop_all_clim_200')
