...
%% COPEPOD
load('copepod-2012_cmass_SON_gridded.mat','lat_g','lon_g',...
    'zoo_g','fileid','units')
...
subplot(3,2,1)
bar(skill(1,:),'k')
title('SON Correlation coefficient')
...
set(gca,'XTickLabel',simtex)
ylim([-40 5])
print('-dpng','corr_rmse_mef_fall_clim_200.png')
...
print('-dpng','Taylor_Joliff_fall_clim_200')
...
print('-dpng','Taylor_fall_clim_200')
...
save('skill_fall_clim_200.mat','model','obs','metrics','skill','T','obsmod');
writetable(obsmod,'obs_mod_fall_clim_200.csv')
