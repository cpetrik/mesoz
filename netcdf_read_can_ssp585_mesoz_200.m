...
%% Meso Zoop zall
ncdisp([fpath 'zmeso_Omon_CanESM5-CanOE_ssp585_r1i1p2f1_gn_201501-210012.nc'])
...
%% 
ncid = netcdf.open([fpath 'zmeso_Omon_CanESM5-CanOE_ssp585_r1i1p2f1_gn_201501-210012.nc'],'NC_NOWRITE');
...
%% Subset of thkcello
ncdisp([fpath 'thkcello_Ofx_CanESM5-CanOE_ssp585_r1i1p2f1_gn.nc'])

%%
tcid = netcdf.open([fpath 'thkcello_Ofx_CanESM5-CanOE_ssp585_r1i1p2f1_gn.nc'],'NC_NOWRITE');
...
save([fpath 'can_ssp585_zmeso_200_monthly_2015_2100.mat'],'zmeso_200','yr',...
