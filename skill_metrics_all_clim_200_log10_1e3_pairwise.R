...
write.table(Kcor,paste0(ddir,"Kendall_corr_hist_clims_200_obsglm100_log10_KK_1e3_v2.csv"),sep=",",row.names=T)
write.table(Scor,paste0(ddir,"Spearman_corr_hist_clims_200_obsglm100_log10_KK_1e3_v2.csv"),sep=",",row.names=T)
