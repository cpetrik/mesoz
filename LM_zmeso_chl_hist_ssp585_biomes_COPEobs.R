...
# load data
Hist1 <- read.csv("Hist_coeffs_mod_chl_biome1_LC.csv",sep=",",header = T,stringsAsFactors = F)
Hist2 <- read.csv("Hist_coeffs_mod_chl_biome2_HCSS.csv",sep=",",header = T,stringsAsFactors = F)
Hist3 <- read.csv("Hist_coeffs_mod_chl_biome3_HCPS.csv",sep=",",header = T,stringsAsFactors = F)
Herr <- read.csv("Hist_stderr_coeff_obs_chl_all_biomes.csv",sep=",",header = T,stringsAsFactors = F)
Oerr1 <- read.csv("Hist_stderr_predict_obs_chl_biome1.csv",sep=",",header = T,stringsAsFactors = F)
Oerr2 <- read.csv("Hist_stderr_predict_obs_chl_biome2.csv",sep=",",header = T,stringsAsFactors = F)
Oerr3 <- read.csv("Hist_stderr_predict_obs_chl_biome3.csv",sep=",",header = T,stringsAsFactors = F)
...
pdf(file = paste0(figp,'Hist_SSP585_lm_zm_chl_biome1_LC_obs.pdf'), width = unit( 10, 'cm' ), height = unit( 5, 'cm' ))
plot_grid( h1,s1,
           nrow = 1, ncol = 2,
...
pdf(file = paste0(figp,'Hist_SSP585_lm_zm_chl_biome2_HCSS.pdf'), width = unit( 10, 'cm' ), height = unit( 5, 'cm' ))
plot_grid( h2,s2,
           nrow = 1, ncol = 2,
           rel_widths = c( 1, 1 ), rel_heights = c( 1, 1 ) ,
           align = 'h' )
...
pdf(file = paste0(figp,'Hist_SSP585_lm_zm_chl_biome3_HCPS.pdf'), width = unit( 10, 'cm' ), height = unit( 5, 'cm' ))
plot_grid( h3,s3,
           nrow = 1, ncol = 2,
           rel_widths = c( 1, 1 ), rel_heights = c( 1, 1 ) ,
           align = 'h' )
...
pdf(file = paste0(figp,'Hist_SSP585_lm_zm_chl_EC_biome1_LC.pdf'), width = unit( 15, 'cm' ), height = unit( 4.5, 'cm' ))
plot_grid( h1,s1,c1,
           nrow = 1, ncol = 3,
           rel_widths = c( 1, 1 ), rel_heights = c( 1, 1 ) ,
           align = 'h' )
...
pdf(file = paste0(figp,'Hist_SSP585_lm_zm_chl_EC_biome2_HCSS.pdf'), width = unit( 15, 'cm' ), height = unit( 4.5, 'cm' ))
plot_grid( h2,s2,c2,
           nrow = 1, ncol = 3,
           rel_widths = c( 1, 1 ), rel_heights = c( 1, 1 ) ,
           align = 'h' )
...
pdf(file = paste0(figp,'Hist_SSP585_lm_zm_chl_EC_biome3_HCPS.pdf'), width = unit( 15, 'cm' ), height = unit( 4.5, 'cm' ))
plot_grid( h3,s3,c3,
           nrow = 1, ncol = 3,
           rel_widths = c( 1, 1 ), rel_heights = c( 1, 1 ) ,
           align = 'h' )
...
#without outliers
pdf(file = paste0(figp,'Hist_SSP585_lm_zm_chl_EC_biome1_LC_noIPSL.pdf'), width = unit( 15, 'cm' ), height = unit( 4.5, 'cm' ))
plot_grid( h1,s1,c11,
           nrow = 1, ncol = 3,
           rel_widths = c( 1, 1 ), rel_heights = c( 1, 1 ) ,
           align = 'h' )
...
pdf(file = paste0(figp,'Hist_SSP585_lm_zm_chl_EC_biome2_HCSS_noCAN.pdf'), width = unit( 15, 'cm' ), height = unit( 4.5, 'cm' ))
plot_grid( h2,s2,c21,
           nrow = 1, ncol = 3,
           rel_widths = c( 1, 1 ), rel_heights = c( 1, 1 ) ,
           align = 'h' )
...
pdf(file = paste0(figp,'Hist_SSP585_lm_zm_chl_EC_biome3_HCPS_noUK.pdf'), width = unit( 15, 'cm' ), height = unit( 4.5, 'cm' ))
plot_grid( h3,s3,c31,
           nrow = 1, ncol = 3,
           rel_widths = c( 1, 1 ), rel_heights = c( 1, 1 ) ,
           align = 'h' )
