...
png(paste0(figp,'corr_ssp585_mesoz_sst_biomes_all_log.png'), 
...
write.table(Bcorr,"SSP585_corrs_mod_sst_biomes.csv",sep=",",row.names=T)
...
write.table(Cff1,"SSP585_coeffs_mod_sst_biome1_LC.csv",sep=",",row.names=T)
...
row.names(Cff2) <- c("CAN","CNRM","GFDL","IPSL","UKESM")
write.table(Cff2,"SSP585_coeffs_mod_sst_biome2_HCSS.csv",sep=",",row.names=T)
...
row.names(Cff3) <- c("CAN","CNRM","GFDL","IPSL","UKESM")
write.table(Cff3,"SSP585_coeffs_mod_sst_biome3_HCPS.csv",sep=",",row.names=T)
