...
%%
ncdisp([fpath 'chlos_Omon_CNRM-ESM2-1_ssp126_r1i1p1f2_gn_201501-210012.nc'])
...
%% All years
ncid = netcdf.open([fpath 'chlos_Omon_CNRM-ESM2-1_ssp126_r1i1p1f2_gn_201501-210012.nc'],'NC_NOWRITE');
...
%%
save([fpath 'cnrm_ssp126_surf_chl_monthly_2015_2100.mat'],'schl',...
