...
%% surf chl
ncdisp([fpath 'chlos_Omon_CanESM5-CanOE_ssp126_r1i1p2f1_gn_201501-210012.nc'])
...
%%
ncid = netcdf.open([fpath 'chlos_Omon_CanESM5-CanOE_ssp126_r1i1p2f1_gn_201501-210012.nc'],'NC_NOWRITE');
