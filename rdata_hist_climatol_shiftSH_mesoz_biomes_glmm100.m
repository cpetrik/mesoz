...
%     'czmo_all','mzmo_all','nzmo_all','gzmo_all','izmo_all','uzmo_all','ozmo_all',...
%     'lon_g','lat_g');
save('cmip6_hist_space_means_50yr_seasons_zmeso200_glmm100_same_orientation.mat',...
    'czmo_all','mzmo_all','nzmo_all','gzmo_all','izmo_all','uzmo_all','ozmo_all',...
    'czmo_DJF','mzmo_DJF','nzmo_DJF','gzmo_DJF','izmo_DJF','uzmo_DJF','ozmo_DJF',...
    'czmo_MAM','mzmo_MAM','nzmo_MAM','gzmo_MAM','izmo_MAM','uzmo_MAM','ozmo_MAM',...
    'czmo_JJA','mzmo_JJA','nzmo_JJA','gzmo_JJA','izmo_JJA','uzmo_JJA','ozmo_JJA',...
    'czmo_SON','mzmo_SON','nzmo_SON','gzmo_SON','izmo_SON','uzmo_SON','ozmo_SON',...
    'lon_g','lat_g');
...
writetable(obsmod,'skill_hist_model_obsglm100_all_clim_200.csv')
...
omDJF = array2table(dcomb,'VariableNames',...
    {'Lat','Lon','CAN','CMCC','CNRM','GFDL','IPSL','UK','obsGLM',...
    'CAbiome','CMbiome','CNbiome','GFbiome','IPbiome','UKbiome','obsbiome'});
writetable(omDJF,'skill_hist_model_obsglm100_DJF_clim_200.csv')
...
omJJA = array2table(jcomb,'VariableNames',...
    {'Lat','Lon','CAN','CMCC','CNRM','GFDL','IPSL','UK','obsGLM',...
    'CAbiome','CMbiome','CNbiome','GFbiome','IPbiome','UKbiome','obsbiome'});
writetable(omJJA,'skill_hist_model_obsglm100_JJA_clim_200.csv')
...
omMAM = array2table(mcomb,'VariableNames',...
    {'Lat','Lon','CAN','CMCC','CNRM','GFDL','IPSL','UK','obsGLM',...
    'CAbiome','CMbiome','CNbiome','GFbiome','IPbiome','UKbiome','obsbiome'});
writetable(omMAM,'skill_hist_model_obsglm100_MAM_clim_200.csv')
...
omSON = array2table(scomb,'VariableNames',...
    {'Lat','Lon','CAN','CMCC','CNRM','GFDL','IPSL','UK','obsGLM',...
    'CAbiome','CMbiome','CNbiome','GFbiome','IPbiome','UKbiome','obsbiome'});
writetable(omSON,'skill_hist_model_obsglm100_SON_clim_200.csv')

%%
save('skill_hist_model_obsglm100_climatols.mat','comb','dcomb','jcomb','mcomb','scomb')
