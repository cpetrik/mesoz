...
pdf( file = paste0(figp,'Taylor_obsglm_winter_200_raw.pdf')) #, width = unit( 5, 'cm' ), height = unit( 5, 'cm' ) )
...
pdf( file = paste0(figp,'Taylor_obsglm_winter_200_norm.pdf')) #, width = unit( 5, 'cm' ), height = unit( 5, 'cm' ) )
...
pdf( file = paste0(figp,'Taylor_obsglm_winter_200_anom.pdf')) #, width = unit( 5, 'cm' ), height = unit( 5, 'cm' ) )
...
pdf( file = paste0(figp,'Taylor_obsglm_winter_200_01.pdf')) #, width = unit( 5, 'cm' ), height = unit( 5, 'cm' ) )
...
pdf( file = paste0(figp,'Taylor_obsglm_winter_200_neg11.pdf')) #, width = unit( 5, 'cm' ), height = unit( 5, 'cm' ) )
t5 <- TaylorDiagram(Tr3, obs = "obsGLM", mod = "esm", group = "model",
                    cols = c("green4", "blue", "purple3", "red3", "maroon4"))
dev.off()


# pdf( file = paste0(figp,'Taylor_obsglm_winter_200_all.pdf'), width = unit( 8, 'cm' ), height = unit( 10, 'cm' ) )
