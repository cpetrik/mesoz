...
subplot(3,2,1)
bar(skill(1,:),'k')
title('JJA Correlation coefficient')
...
set(gca,'XTickLabel',simtex)
ylim([-20 2])
print('-dpng','corr_rmse_mef_summer_clim_200.png')
...
print('-dpng','Taylor_Joliff_summer_clim_200')
...
print('-dpng','Taylor_summer_clim_200')
...
save('skill_summer_clim_200.mat','model','obs','metrics','skill','T','obsmod');
writetable(obsmod,'obs_mod_summer_clim_200.csv')
