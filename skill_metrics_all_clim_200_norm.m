...
save('skill_scores_hist_model_obsglm_clim_norm.mat','skill','simtext','metrics','ctext')
...
% set(gca,'XTickLabel',simtex)
% %ylim([-15 5])
% print('-dpng',[figp 'corr_rmse_bias_clims_200_obsglm_neg11_subplot.png'])
...
% title('Bias')
% set(gca,'XTickLabel',ctext)
% print('-dpng',[figp 'corr_rmse_bias_clims_200_obsglm_neg11_together.png'])
...
writetable(Tcorr,[sfile 'corr_hist_clims_200_obsglm_norm.csv'],'WriteRowNames',true);
writetable(Trmse,[sfile 'rmse_hist_clims_200_obsglm_norm.csv'],'WriteRowNames',true);
writetable(Tnstd,[sfile 'nstd_hist_clims_200_obsglm_norm.csv'],'WriteRowNames',true);
writetable(Turmse,[sfile 'urmse_hist_clims_200_obsglm_norm.csv'],'WriteRowNames',true);
writetable(Ttrmse,[sfile 'trmse_hist_clims_200_obsglm_norm.csv'],'WriteRowNames',true);
writetable(Tbias,[sfile 'bias_hist_clims_200_obsglm_norm.csv'],'WriteRowNames',true);
