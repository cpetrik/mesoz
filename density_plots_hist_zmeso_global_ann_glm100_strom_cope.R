...
# from mgC to gC
Zm$Copepod <- Zm$Copepod*1e-3

# Log10 transform - do with plot
#Zm[,3:9] <- log10(Zm[,3:9]+1e-3)
#Zm[,17:18] <- log10(Zm[,17:18]+1e-3)
...
## With Global
png(paste0(figp,'scatter_hist_zmeso_global_esm_vs_obs_log10.png'), 
