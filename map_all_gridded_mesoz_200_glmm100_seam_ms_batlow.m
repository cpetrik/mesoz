...
print('-dpng',[ppath 'Map_all_hist_clim_glmm100_log10mgCm-2_int200m_ms_batlow.png'])
...
print('-dpng',[ppath 'Map_all_hist_clim_glmm100_log10mgCm-2_int200m_bins_batlow.png'])
...
text(0.2,1.65,'obsGLMM','HorizontalAlignment','center','FontWeight','bold')
cb = colorbar;%('Position',[0.8 0.3 0.03 0.5],'orientation','vertical');
contourm(lat_s,lon_s,log10(oz_s),2:0.5:3,'LineColor','k')
xlabel(cb,'zmeso (log_1_0 mgC m^-^2)')
...
caxis([1.5 3.5])
set(gcf,'renderer','painters')
contourm(lat_s,lon_s,log10(cz_s),2:0.5:3,'LineColor','k')
text(0.2,1.65,'CAN','HorizontalAlignment','center','FontWeight','bold')
...
caxis([1.5 3.5])
set(gcf,'renderer','painters')
contourm(lat_s,lon_s,log10(nz_s),2:0.5:3,'LineColor','k')
text(0.2,1.65,'CNRM','HorizontalAlignment','center','FontWeight','bold')
...
caxis([1.5 3.5])
set(gcf,'renderer','painters')
contourm(lat_s,lon_s,log10(iz_s),2:0.5:3,'LineColor','k')
text(0.2,1.65,'IPSL','HorizontalAlignment','center','FontWeight','bold')
...
%colorbar('Position',[0.92 0.25 0.025 0.5],'orientation','vertical','AxisLocation','out')
set(gcf,'renderer','painters')
contourm(lat_s,lon_s,log10(mz_s),2:0.5:3,'LineColor','k')
text(0.2,1.65,'CMCC','HorizontalAlignment','center','FontWeight','bold')
...
caxis([1.5 3.5])
set(gcf,'renderer','painters')
contourm(lat_s,lon_s,log10(gz_s),2:0.5:3,'LineColor','k')
text(0.2,1.65,'GFDL','HorizontalAlignment','center','FontWeight','bold')
...
caxis([1.5 3.5])
set(gcf,'renderer','painters')
contourm(lat_s,lon_s,log10(uz_s),2:0.5:3,'LineColor','k')
text(0.2,1.65,'UKESM','HorizontalAlignment','center','FontWeight','bold')

print('-dpng',[ppath 'Map_all_hist_clim_glmm100_log10mgCm-2_int200m_contour_batlow.png'])
