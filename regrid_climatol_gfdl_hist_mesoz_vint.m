...
zD = griddata(LAT,LON,gzD,lat_g,lon_g);
zM = griddata(LAT,LON,gzM,lat_g,lon_g);
zJ = griddata(LAT,LON,gzJ,lat_g,lon_g);
zS = griddata(LAT,LON,gzS,lat_g,lon_g);
zall = griddata(LAT,LON,gz,lat_g,lon_g);
...
save([hpath 'gfdl_hist_zmeso_vint_climatol_1950_2014_gridded.mat'],...
    'lat_g','lon_g',...
