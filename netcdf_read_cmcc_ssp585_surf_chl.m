...
%%
ncdisp([fpath 'chlos_Omon_CMCC-ESM2_ssp585_r1i1p1f1_gn_201501-210012.nc'])
...
%% All years
ncid = netcdf.open([fpath 'chlos_Omon_CMCC-ESM2_ssp585_r1i1p1f1_gn_201501-210012.nc'],'NC_NOWRITE');
...
save([fpath 'cmcc_ssp585_surf_chl_monthly_2015_2100.mat'],'schl',...
