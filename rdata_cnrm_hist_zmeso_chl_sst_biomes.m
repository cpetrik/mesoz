...
load([fpath 'CNRM_historical_biomes.mat'],'biomes');
...
save('cnrm_hist_zmeso200_chl_sst_clim_1965_2014_biomes.mat','model','comb','obsmod');
writetable(obsmod,'cnrm_hist_zmeso200_chl_sst_clim_1965_2014_biomes.csv')
