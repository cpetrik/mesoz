...
% log10
Acomb = log10(1e3*(comb(:,3:9)+1e-4));
Dcomb = log10(1e3*(dcomb(:,3:9)+1e-4));
Jcomb = log10(1e3*(jcomb(:,3:9)+1e-4));
Mcomb = log10(1e3*(mcomb(:,3:9)+1e-4));
Scomb = log10(1e3*(scomb(:,3:9)+1e-4));
...
save([sfile 'skill_scores_hist_model_copepod_clim_log10_KK_1e4_mgC.mat'],'skill',...
...
writetable(Tcorr,[sfile 'corr_hist_clims_200_copepod_log10_KK_1e4_mgC.csv'],'WriteRowNames',true);
writetable(Trmse,[sfile 'rmse_hist_clims_200_copepod_log10_KK_1e4_mgC.csv'],'WriteRowNames',true);
writetable(Tnstd,[sfile 'nstd_hist_clims_200_copepod_log10_KK_1e4_mgC.csv'],'WriteRowNames',true);
writetable(Turmse,[sfile 'urmse_hist_clims_200_copepod_log10_KK_1e4_mgC.csv'],'WriteRowNames',true);
writetable(Tmae,[sfile 'mae_hist_clims_200_copepod_log10_KK_1e4_mgC.csv'],'WriteRowNames',true);
writetable(Tbias,[sfile 'bias_hist_clims_200_copepod_log10_KK_1e4_mgC.csv'],'WriteRowNames',true);
...
writetable(TAcomb,[sfile 'climatol_All_hist_clims_200_copepod_log10_1e4_mgC.csv'],'WriteRowNames',false);
writetable(TDcomb,[sfile 'climatol_DJF_hist_clims_200_copepod_log10_1e4_mgC.csv'],'WriteRowNames',false);
writetable(TJcomb,[sfile 'climatol_JJA_hist_clims_200_copepod_log10_1e4_mgC.csv'],'WriteRowNames',false);
writetable(TMcomb,[sfile 'climatol_MAM_hist_clims_200_copepod_log10_1e4_mgC.csv'],'WriteRowNames',false);
writetable(TScomb,[sfile 'climatol_SON_hist_clims_200_copepod_log10_1e4_mgC.csv'],'WriteRowNames',false);
