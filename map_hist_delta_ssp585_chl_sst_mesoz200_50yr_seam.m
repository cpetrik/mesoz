...
[~,~,diff_ct2] = cyclic_map_seam(lat_g,lon_g,diff_ct);
...
h=patchm(coastlat+0.5,coastlon+0.5,'w','FaceColor',[0.75 0.75 0.75]);
colorbar('Position',[0.18 0.075 0.275 0.02],'orientation','horizontal');
...
text(0,2.2,'\Delta SST','HorizontalAlignment','center','FontWeight','bold')
text(-1.95,1.75,'CMCC','HorizontalAlignment','center')
h=patchm(coastlat+0.5,coastlon+0.5,'w','FaceColor',[0.75 0.75 0.75]);
...
text(-1.95,1.75,'UK','HorizontalAlignment','center')
h=patchm(coastlat+0.5,coastlon+0.5,'w','FaceColor',[0.75 0.75 0.75]);
colorbar('Position',[0.64 0.075 0.275 0.02],'orientation','horizontal');

print('-dpng',[ppath 'Map_sst_chl_zmeso_pdiff_Hist_SSP585_50s.png'])
...
axesm ('Robinson','MapLatLimit',clatlim,'MapLonLimit',clonlim,'frame','on',...
    'Grid','off','FLineWidth',1)
surfm(lat_corr,lon_corr,pdiff_cz2)
cmocean('balance')
caxis([-100 100])
colorbar('Position',[0.18 0.45 0.275 0.025],'orientation','horizontal');
text(-2.5,2.25,'a','FontWeight','bold','FontSize',14)
...
caxis([-8 8])
text(-2.5,2.25,'c','FontWeight','bold','FontSize',14)
text(0,1.75,'\Delta SST','HorizontalAlignment','center','FontWeight','bold')
%text(0.2,1.65,'CAN','HorizontalAlignment','center','FontWeight','bold')
h=patchm(coastlat+0.5,coastlon+0.5,'w','FaceColor',[0.75 0.75 0.75]);
colorbar('Position',[0.64 0.45 0.275 0.025],'orientation','horizontal');
print('-dpng',[ppath 'Map_sst_chl_zmeso_pdiff_Hist_SSP585_50s_CANonly.png'])
