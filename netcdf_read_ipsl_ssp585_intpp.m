...
%% intpp zall
ncdisp([fpath 'ipsl-cm6a-lr_r1i1p1f1_ssp585_intpp_onedeg_global_monthly_2015_2100.nc'])
...
%%
ncid = netcdf.open([fpath 'ipsl-cm6a-lr_r1i1p1f1_ssp585_intpp_onedeg_global_monthly_2015_2100.nc'],'NC_NOWRITE');
...
%%
save([fpath 'ipsl_ssp585_npp_monthly_2015_2100.mat'],'npp','yr',...
