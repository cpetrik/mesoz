...
load([fpath 'ukesm_isimip_hist_sst_monthly_1950_2014.mat'])
load([fpath 'ukesm_isimip_hist_surf_chl_monthly_1950_2014.mat'])
...
%%
save([fpath 'ukesm_hist_chl_sst_onedeg_climatol_1965_2014.mat'],'yr','time',...
    'long_name','standard_name','units','lat','lon','runs','yid',...
