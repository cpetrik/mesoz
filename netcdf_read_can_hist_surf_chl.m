...
%% surf chl
ncdisp([fpath 'chlos_Omon_CanESM5-CanOE_historical_r1i1p2f1_gn_185001-201412.nc'])
...
%%
ncid = netcdf.open([fpath 'chlos_Omon_CanESM5-CanOE_historical_r1i1p2f1_gn_185001-201412.nc'],'NC_NOWRITE');
...
%%
save([fpath 'can_hist_surf_chl_monthly_1950_2014.mat'],'schl',...
