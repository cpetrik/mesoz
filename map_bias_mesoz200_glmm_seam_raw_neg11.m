...
% v3 = Add half of min instead of eps
...
print('-dpng',[ppath 'Map_all_hist_clim_glmm_log_scale.png'])
...
set(gcf,'renderer','painters')
text(0.2,1.65,'UKESM','HorizontalAlignment','center','FontWeight','bold')
print('-dpng',[ppath 'Map_all_hist_clim_glmm_neg11_scale.png'])
...
print('-dpng',[ppath 'Map_bias_all_hist_clim_glmm_log_scale.png'])
...
print('-dpng',[ppath 'Map_bias_all_hist_clim_glmm_neg11_scale.png'])
