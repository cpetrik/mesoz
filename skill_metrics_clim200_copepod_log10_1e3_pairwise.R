...
Amod <- read.csv(paste0(ddir,"climatol_All_hist_clims_200_copepod_log10_1e4.csv"),sep=",",header = T,stringsAsFactors = F)
Dmod <- read.csv(paste0(ddir,"climatol_DJF_hist_clims_200_copepod_log10_1e4.csv"),sep=",",header = T,stringsAsFactors = F)
Mmod <- read.csv(paste0(ddir,"climatol_MAM_hist_clims_200_copepod_log10_1e4.csv"),sep=",",header = T,stringsAsFactors = F)
Jmod <- read.csv(paste0(ddir,"climatol_JJA_hist_clims_200_copepod_log10_1e4.csv"),sep=",",header = T,stringsAsFactors = F)
Smod <- read.csv(paste0(ddir,"climatol_SON_hist_clims_200_copepod_log10_1e4.csv"),sep=",",header = T,stringsAsFactors = F)
...
write.table(Kcor,paste0(ddir,"Kendall_corr_hist_clims_200_copepod_log10_KK_1e4.csv"),sep=",",row.names=T)
write.table(Scor,paste0(ddir,"Spearman_corr_hist_clims_200_copepod_log10_KK_1e4.csv"),sep=",",row.names=T)
write.table(Pcor,paste0(ddir,"Pearson_corr_hist_clims_200_copepod_log10_KK_1e4.csv"),sep=",",row.names=T)
