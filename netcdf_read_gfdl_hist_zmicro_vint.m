...
%% phyc zall
ncdisp([fpath 'gfdl-esm4_r1i1p1f1_historical_zmicro_vint_onedeg_global_monthly_1850_2014.nc'])
...
%%
ncid = netcdf.open([fpath 'gfdl-esm4_r1i1p1f1_historical_zmicro_vint_onedeg_global_monthly_1850_2014.nc'],'NC_NOWRITE');
...
for i = (nvars)
    varname = netcdf.inqVar(ncid, i-1);
    zmicrovint = netcdf.getVar(ncid,i-1);
    %eval([ varname '(' varname ' == 1.000000020040877e+20) = NaN;']);
end
netcdf.close(ncid);
...
%% mean over time
zmicro_vint = squeeze(zmicrovint(:,:,runs));

%%
save([fpath 'gfdl_hist_zmicro_vint_monthly_1951_2014.mat'],'zmicro_vint','yr',...
