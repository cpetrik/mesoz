...
%% CAN ---------------------------------------------------------------
cpath = '/Volumes/MIP/Fish-MIP/CMIP6/CanESM5/ssp126/';
load([cpath 'can_ssp126_zmeso_200_monthly_2015_2100.mat'],'latitude','longitude',...
    'zmeso_200','yr');

time = yr;
file_czoo = [cpath 'zmeso200_Omon_CanESM5-CanOE_ssp126_r1i1p2f1_gn_2015_2100.nc'];
...
%% CNRM ---------------------------------------------------------------
npath = '/Volumes/MIP/Fish-MIP/CMIP6/CNRM-ESM2-1/ssp126/';
load([npath 'cnrm_ssp126_zmeso_200_monthly_2015_2100.mat'],'lat','lon',...
    'zmeso_200','yr1','yr2');

file_nzoo = [npath 'zmeso200_Omon_CNRM-ESM2-1_ssp126_r1i1p1f2_gn_2015_2100.nc'];
