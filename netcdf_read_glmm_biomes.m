...
%% biomes
ncdisp([bpath 'glm_obs_surf_chl_modisaqua.nc'])
...
%%
ncid = netcdf.open([bpath 'glm_obs_surf_chl_modisaqua.nc'],'NC_NOWRITE');
...
%%
save([bpath 'glm_obs_surf_chl_modisaqua.mat']);
...
print('-dpng',[ppath 'Map_GLMM_MODIS_biomes_hist.png'])
