...
%% 
load('obs_mod_chl_stemp_falwin_clim_200.mat')
obs = obsmodchl(:,3);
model = obsmodchl(:,4:8);
...
subplot(3,2,2)
bar(skill(1,:),'k')
text(-1,0.25,'Correlation coefficient','FontWeight','Bold','HorizontalAlignment','center')
set(gca,'XTickLabel',simtex)
ylim([0 0.2])

subplot(3,2,4)
bar(skill(2,:),'k')
text(-1,1.2,'Root mean square error','FontWeight','Bold','HorizontalAlignment','center')
set(gca,'XTickLabel',simtex)
ylim([0 1])
...
set(gca,'XTickLabel',simtex)
ylim([-2.5 0.1])
stamp('S Temp Fal-Win')
print('-dpng','corr_rmse_mef_stemp_falwin_clim_200.png')
...
print('-dpng','Taylor_stemp_falwin_clim_200_clim_200')
