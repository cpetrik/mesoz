...
# load data
Tr <- read.csv("obs_mod_chl_ntemp_sprsum_clim_200.csv",sep=",",header = T,stringsAsFactors = F)
...
pdf( file = 'Taylor_ntemp_clim_200_log.pdf') #, width = unit( 5, 'cm' ), height = unit( 5, 'cm' ) )
...
pdf( file = 'Taylor_noCAN_ntemp_clim_200_log.pdf') #, width = unit( 5, 'cm' ), height = unit( 5, 'cm' ) )
