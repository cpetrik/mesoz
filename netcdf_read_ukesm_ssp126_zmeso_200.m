...
%% Meso Zoop zall
ncdisp([fpath 'ukesm1-0-ll_r1i1p1f2_ssp126_zmeso_onedeg_global_monthly_2015_2100.nc'])
...
%%
ncid = netcdf.open([fpath 'ukesm1-0-ll_r1i1p1f2_ssp126_zmeso_onedeg_global_monthly_2015_2100.nc'],'NC_NOWRITE');
...
%% Subset of thkcello
tcid = netcdf.open([fpath 'ukesm1-0-ll_r1i1p1f2_ssp126_thkcello_onedeg_global_monthly_2015_2100.nc'],'NC_NOWRITE');
