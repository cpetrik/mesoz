...
cpath = '/Volumes/MIP/Fish-MIP/CMIP6/CMCC/ssp585/';

%% CMCC ---------------------------------------------------------------
load([cpath 'cmcc_ssp585_mld_monthly_2015_2100.mat'],'mld');
load([cpath 'cmcc_ssp585_sst_monthly_2015_2100.mat'],'sst');
load([cpath 'cmcc_ssp585_surf_chl_monthly_2015_2100.mat'],'schl','yr','runs');
load([cpath 'cmcc_ssp585_zmeso_200_monthly_2015_2100.mat'],'lat','lon','mod_yr',...
    'zmeso_200');
...
fname2 = '_Omon_CMCC-ESM2_ssp585_r1i1p1f1_gn_2015_2100.nc';
