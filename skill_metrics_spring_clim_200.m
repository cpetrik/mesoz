...
subplot(3,2,1)
bar(skill(1,:),'k')
title('MAM Correlation coefficient')
...
set(gca,'XTickLabel',simtex)
ylim([-40 5])
print('-dpng','corr_rmse_mef_spring_clim_200.png')
...
print('-dpng','Taylor_Joliff_spring_clim_200')
...
print('-dpng','Taylor_spring_clim_200')
...
save('skill_spring_clim_200.mat','model','obs','metrics','skill','T','obsmod');
writetable(obsmod,'obs_mod_spring_clim_200.csv')
