...
%% 
load('obs_mod_chl_npol_summer_clim_200.mat')
obs = obsmodchl(:,3);
model = obsmodchl(:,4:8);
...
subplot(3,2,2)
bar(skill(1,:),'k')
text(-1,0.4,'Summer Correlation coefficient','FontWeight','Bold','HorizontalAlignment','center')
set(gca,'XTickLabel',simtex)
ylim([0 0.35])

subplot(3,2,4)
bar(skill(2,:),'k')
text(-1,0.9,'Root mean square error','FontWeight','Bold','HorizontalAlignment','center')
set(gca,'XTickLabel',simtex)
ylim([0 0.8])

subplot(3,2,6)
bar(skill(6,:),'k')
text(-1,0.5,'Modeling efficiency','FontWeight','Bold','HorizontalAlignment','center')
set(gca,'XTickLabel',simtex)
ylim([-2.5 0.2])
stamp('N Polar Summer')
print('-dpng','corr_rmse_mef_npol_summer_clim_200.png')
...
print('-dpng','Taylor_npol_summer_clim_200_clim_200')
