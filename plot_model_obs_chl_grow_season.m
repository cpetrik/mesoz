...
% obs chl is growing season, so maybe only look at annual 30S-30N
...
figure(4)
subplot(2,3,1)
scatter(log10(chl_ocx(:)),log10(cz(:))); hold on
plot(x,x,'--k')
%axis([0 5 -10 4.5])

subplot(2,3,2)
scatter(log10(chl_ocx(:)),log10(nz(:)));hold on
plot(x,x,'--k')
%axis([0 5 1.5 4.5])

subplot(2,3,3)
scatter(log10(chl_ocx(:)),log10(gz(:)));hold on
plot(x,x,'--k')
%axis([0.5 5 1.5 4])

subplot(2,3,4)
scatter(log10(chl_ocx(:)),log10(iz(:)));hold on
plot(x,x,'--k')
%axis([0 5 1 3.5])

subplot(2,3,5)
scatter(log10(chl_ocx(:)),log10(uz(:)));hold on
plot(x,x,'--k')
%axis([0 5 0 4])
