...
save('skill_scores_hist_model_copepod_clim_log10.mat','skill','simtext','metrics','ctext')
...
writetable(Tcorr,[sfile 'corr_hist_clims_200_copepod_log10.csv'],'WriteRowNames',true);
writetable(Trmse,[sfile 'rmse_hist_clims_200_copepod_log10.csv'],'WriteRowNames',true);
writetable(Tnstd,[sfile 'nstd_hist_clims_200_copepod_log10.csv'],'WriteRowNames',true);
writetable(Turmse,[sfile 'urmse_hist_clims_200_copepod_log10.csv'],'WriteRowNames',true);
writetable(Ttrmse,[sfile 'trmse_hist_clims_200_copepod_log10.csv'],'WriteRowNames',true);
writetable(Tbias,[sfile 'bias_hist_clims_200_copepod_log10.csv'],'WriteRowNames',true);
