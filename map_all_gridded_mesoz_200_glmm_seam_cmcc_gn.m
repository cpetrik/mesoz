...
%     'zmo_all','lat','lon');
load([mpath 'cmcc_hist_zmeso200_climatol_1965_2014.mat'],...
    'zmo_all','lat','lon');
...
[lat_ms,lon_ms,mz_s] = cyclic_map_seam(lat_m,lon_m,mz);
...
%A - obsGLMM shifted
subplot('Position',[0.25 0.75 0.44 0.25])
axesm ('Robinson','MapLatLimit',clatlim,'MapLonLimit',clonlim,'frame','on',...
...
print('-dpng',[ppath 'Map_all_hist_clim_glmm_log10mgCm-2_int200m_cmcc.png'])
