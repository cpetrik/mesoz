...
# load data
Hist1 <- read.csv("Hist_coeffs_mod_chl_biome1_LC_obsglm_norm.csv",sep=",",header = T,stringsAsFactors = F)
Hist2 <- read.csv("Hist_coeffs_mod_chl_biome2_HCSS_obsglm_norm.csv",sep=",",header = T,stringsAsFactors = F)
Hist3 <- read.csv("Hist_coeffs_mod_chl_biome3_HCPS_obsglm_norm.csv",sep=",",header = T,stringsAsFactors = F)
...
pdf(file = paste0(figp,'Hist_SSP585_lm_zm_chl_biome1_LC_obsglm_norm.pdf'), width = unit( 10, 'cm' ), height = unit( 5, 'cm' ))
plot_grid( h1,s1,
           nrow = 1, ncol = 2,
