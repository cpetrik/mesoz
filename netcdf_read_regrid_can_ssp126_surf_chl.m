% Read CMIP6 CanESM5 SSP126 netcdfs
% surface chl
...
%% surf chl
ncdisp([fpath 'chlos_Omon_CanESM5-CanOE_ssp126_r1i1p2f1_gn_201501-210012_onedeg.nc'])
...
%%
ncid = netcdf.open([fpath 'chlos_Omon_CanESM5-CanOE_ssp126_r1i1p2f1_gn_201501-210012_onedeg.nc'],'NC_NOWRITE');
...
%%
save([fpath 'can_ssp126_surf_chl_monthly_onedeg_2015-2100.mat'],'schl',...
