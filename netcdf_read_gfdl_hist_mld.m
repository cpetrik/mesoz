...
spath='/Volumes/MIP/Fish-MIP/CMIP6/GFDL/hist/';

%% intpp zall
ncdisp([fpath 'mlotst_Omon_GFDL-ESM4_historical_r1i1p1f1_gr_195001-196912.nc'])
...
%% time slices
ttex = {'195001-196912', '197001-198912', '199001-200912','201001-201412'};

%%
mlot =[];
tall = [];
for t = 1:length(ttex)
ncid = netcdf.open([fpath 'mlotst_Omon_GFDL-ESM4_historical_r1i1p1f1_gr_',ttex{t},'.nc'],'NC_NOWRITE');
...
%%
save([spath 'gfdl_hist_mld_monthly_1965_2014.mat'],'mld','yr',...
