...
# load data
CM <- read.csv("can_mod_zoo_chl_sst_all_clim_200.csv",sep=",",header = T,stringsAsFactors = F)
NM <- read.csv("cnrm_mod_zoo_chl_sst_all_clim_200.csv",sep=",",header = T,stringsAsFactors = F)
GM <- read.csv("gfdl_mod_zoo_chl_sst_all_clim_200.csv",sep=",",header = T,stringsAsFactors = F)
IM <- read.csv("ipsl_mod_zoo_chl_sst_all_clim_200.csv",sep=",",header = T,stringsAsFactors = F)
UM <- read.csv("ukesm_mod_zoo_chl_sst_all_clim_200.csv",sep=",",header = T,stringsAsFactors = F)
