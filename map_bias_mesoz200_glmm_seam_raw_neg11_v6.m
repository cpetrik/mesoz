...
stamp(stex)
print('-dpng',[ppath 'Map_all_hist_clim_glmm_sqrt_scale_v6.png'])
...
text(0.2,1.65,'UKESM','HorizontalAlignment','center','FontWeight','bold')
stamp(stex)
print('-dpng',[ppath 'Map_all_hist_clim_glmm_neg11_scale_v6.png'])
...
h=patchm(coastlat+0.5,coastlon+0.5,'w','FaceColor',[0.75 0.75 0.75]);
stamp(stex)
print('-dpng',[ppath 'Map_bias_all_hist_clim_glmm_sqrt_scale_v6.png'])
...
h=patchm(coastlat+0.5,coastlon+0.5,'w','FaceColor',[0.75 0.75 0.75]);
stamp(stex)
print('-dpng',[ppath 'Map_bias_all_hist_clim_glmm_neg11_scale_v6.png'])
