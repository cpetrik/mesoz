...
%% Hist
load([hpath 'cnrm_hist_zmeso_200_climatol_1950_2014.mat']);
...
title('All 1^o')
print('-dpng','cnrm_zoo_carbon_mass_all.png')

%% save
units = 'Total Carbon Mass mgC m-2';
save([hpath 'cnrm_hist_zmeso_200_climatol_1950_2014_gridded.mat'],...
    'lat_g','lon_g',...
