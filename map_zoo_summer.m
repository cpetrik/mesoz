...
%% load
load('copepod-2012_cmass-m15-qtr.mat')
...
% title('Summer 1/2^o')
% print('-dpng','Total_zoo_carbon_mass_summer_half.png')
...
h=patchm(lat+0.5,long+0.5,'w','FaceColor',[0.75 0.75 0.75]);
title('Summer 1^o')
print('-dpng','Total_zoo_carbon_mass_summer_one.png')

%% save
fileid = COPEPOD2012fileidentifier(1);
units = 'Total Carbon Mass mgC m-3';
save('copepod-2012_cmass_JJA_gridded.mat','lat_c','lon_c','zoo_c','lat_g','lon_g',...
    'zoo_g','fileid','units');
