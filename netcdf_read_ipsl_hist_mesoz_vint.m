...
%% Meso Zoop vint
ncdisp([fpath 'ipsl-cm6a-lr_r1i1p1f1_historical_zmeso-vint_onedeg_global_monthly_1850_2014.nc'])
...
%% 
ncid = netcdf.open([fpath 'ipsl-cm6a-lr_r1i1p1f1_historical_zmeso-vint_onedeg_global_monthly_1850_2014.nc'],'NC_NOWRITE');
...
%%
save([fpath 'ipsl_hist_zmeso_vint_monthly_1950_2014.mat'],'zmeso_vint','yr',...
