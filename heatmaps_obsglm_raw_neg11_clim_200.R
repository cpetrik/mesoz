...
rval3$Model <- factor(rval3$Model,levels = c("UK","IPSL","GFDL","CNRM","CAN"))
rms3$Model <- factor(rms3$Model,levels = c("UK","IPSL","GFDL","CNRM","CAN"))
bia3$Model <- factor(bia3$Model,levels = c("UK","IPSL","GFDL","CNRM","CAN"))
...
nrval3$Model <- factor(nrval3$Model,levels = c("UK","IPSL","GFDL","CNRM","CAN"))
nrms3$Model <- factor(nrms3$Model,levels = c("UK","IPSL","GFDL","CNRM","CAN"))
nbia3$Model <- factor(nbia3$Model,levels = c("UK","IPSL","GFDL","CNRM","CAN"))
...
png(paste0(figp,'Heatmaps_clims_200_obsglm_raw_neg11_cb_v2.png'), 
